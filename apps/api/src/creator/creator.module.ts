 ...
 *
 * Deliberately depends on nothing but notifications, Part 5 monitoring, Prisma
 * and config — and the monitoring module itself depends on nothing but Prisma. The
 ...
 */
@Module({
  imports: [MarketHealthModule, NotificationsModule],
  providers: [
    CreatorService,
